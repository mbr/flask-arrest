...
def test_default_is_json(apibp):
    assert apibp.incoming.get_mimetypes() == {'application/json'}
...
def test_add_default_mimetypes(apibp):
    ...
    assert apibp.incoming.get_mimetypes() == \
        {'application/json', 'application/new'}
